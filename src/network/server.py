...
def main() -> None:
    ...
    parser.add_argument("--ngrok", action="store_true", help="Expose server to the internet using ngrok")
    ...
    if args.ngrok:
        try:
            ...
            print("pyngrok is not installed. Please install it with 'pip install pyngrok'.")
            return
        port = args.port
        print(f"[Tri-Checker] Starting ngrok tunnel for port {port}...")
        tunnel = ngrok.connect(port, "tcp")
        print(f"[Tri-Checker] ngrok tunnel started: {tunnel.public_url}")
        print("Share this address with your friends to join:")
